...
class Unicycle(gym.Env):
	...
	def __init__(self, sys=None, fixed_start=False, normalized_actions=True, expand_limits=False):
		...
		if (sys is None):
			...
			goal = np.zeros((9, 1)) # yaw, roll, pitch, turntable, dyaw, droll, dpitch, dwheel, dturntable
			goal[7,0] = 20
	...
	def dyn(self, x, u):
		...
		dx[4,0] = et25+et26
		dx[5,0] = et27+et28+et29
		dx[6,0] = et30+et31
		dx[7,0] = et39+et40+et41 - (et30+et31)
		dx[8,0] = et42+et43+et44+et45+et46
	...
	def dyn_full(self, x, u):
		...
		# x = [x, y, z, yaw, roll, pitch, turntable, vx, vy, vz, dyaw, droll, dpitch, dwheel, dturntable]
