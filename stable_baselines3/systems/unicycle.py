...
class Unicycle(gym.Env):
	...
	def __init__(self, param=dict(), dt=1e-3, T=2., normalized_actions=True, normalized_observations=False, nonlinear_cost=True, intermittent_starts=False, alpha_cost=1., alpha_action_cost=1., alpha_terminal_cost=1.):
		...
		param_ = {'mw': mw, 'mf': mf, 'md': md, 'rw': rw, 'rf': rf, 'rd': rd, \
			...
			# 'Q_quadratic': np.diag([0.25, 0.25, 0.25, 0.025, 0.0001, 0.00025, 0.00005, 0.0001]), 'R_quadratic': (np.eye(2) / 5000.), 'QT_quadratic': 2*np.diag([1.,1.,1.,1.,1.,1.,1.,1.]),\
			# 'Q_quadratic': np.diag([0.25, 0.25, 0.25, 0.025, 0.00025, 0.0001, 0.0001, 0.00025]), 'R_quadratic': (np.eye(2) / 5000.), 'QT_quadratic': 2*np.diag([1.,1.,1.,1.,1.,1.,1.,1.]),\
